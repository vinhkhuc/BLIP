...
def main(args, config):
    ...
    train_dataset, val_dataset, test_dataset = create_dataset('caption_diffusiondb', config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/caption_diffusiondb.yaml')
    parser.add_argument('--output_dir', default='output/Caption_DiffusionDB')
